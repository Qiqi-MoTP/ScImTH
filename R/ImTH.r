#' quantifying Immune Tumor Heterogeneity
#'
#' @param data A data.frame of the proportion of the immune cell across samples. 
#' @param type A character vector indicating the type of "CIBERSORT", "custom".
#'
#' @returns A data frame containing sample IDs and Immune Tumor Heterogeneity scores -- ImTH score
#' @export
#'
#' @examples
#' # Example usage:
...
ImTH <- function(data, type = c("CIBERSORT", "custom")) {
  ...
  if (type == "CIBERSORT") {
    ...
    # Check the proportion and automatically normalize
